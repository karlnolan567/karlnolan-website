---
title: Smart Inbox Pilot
source: https://www.bespoke-ai.ie/smart-inbox.html
scope: website-knowledge
---

# Smart Inbox Pilot

> Synced from `smart-inbox.html` for the website chatbot knowledge base.
...
[Book a Discovery Call](https://www.bespoke-ai.ie/#discovery-call) · [See the case study](https://www.bespoke-ai.ie/case-studies.html#case-study-inbox)
...
- Someone who will approve before anything leaves the building

### Not a fit — We will turn this down

- Startups wanting a shiny chatbot or FAQ bot as the product
...
- Intake from the existing shared mailbox
...
- Extra mailboxes, ticketing-system rebuilds, or a second helpdesk
- A public chat widget, voice bot, or generic assistant
- Auto-send at launch
...
### Case study — B2B SaaS · ~400 support emails/week

First 60 days (~1,600 emails): median time to flag urgent messages 4 min (was 24+ hrs); routine enquiries drafted within 2 hrs; 85% of drafts sent with minor edits only; zero messages sent without human approval.

[Full case study](https://www.bespoke-ai.ie/case-studies.html#case-study-inbox)
