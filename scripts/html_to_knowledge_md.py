...
def front_matter(title: str, source: str) -> str:
    return (
        f"---\n"
        f"title: {title}\n"
        f"source: http://178.104.254.165/{source}\n"
...
This assistant answers questions **only** about Bespoke Core AI Engineering Limited, its services, workshops, case studies, and content on http://178.104.254.165/
