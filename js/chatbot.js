(function () {
  ...
  function setOpen(open) {
    ...
    if (open) {
      warmKnowledgeCache();
      if (!greeted) {
        appendMessage('assistant', SITE.chatGreeting || 'Hi — I\'m Ask BCAI (Bespoke Core AI Engineering). I can answer questions about Bespoke AI and this website. What would you like to know?');
        greeted = true;
      }
      input.focus();
    }
