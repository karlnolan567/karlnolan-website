...
export CHAT_EMBED_URL="${CHAT_EMBED_URL:-https://genai-app-bespokeaiassistant-1-1785325027030-793778137823.europe-west1.run.app/?key=9B4GmNgIo1df5jd519Eqgun3ObMSuvPW}"
